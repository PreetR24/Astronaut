...
var scheduleController_1 = require("./app/controllers/scheduleController");
...
rl.on('line', function (line) { return __awaiter(void 0, void 0, void 0, function () {
    var input, parts, args, cmd, shouldExit, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                args = parts.map(function (p) { return p.replace(/^"|"$/g, ''); });
                cmd = args[0].toLowerCase();
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, scheduleController_1.scheduleController)(cmd, args.slice(1))];
            case 2:
                shouldExit = _a.sent();
                if (shouldExit) {
                    rl.close();
